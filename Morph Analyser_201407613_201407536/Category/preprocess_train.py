...
def gender_root_feature(f ,features,category,root):
    i=-1
    start=0
    for l in f:
        lines=l.rstrip('\n')
...
gender_root_feature(f,features,category,root)
print features
